                ...
                <div class="table-responsive p-3">
                  ...
                  <?php
                       ...
                       if($type == "1"){ 
                        ...
                        $query ="SELECT a.Id, a.admissionNo, a.classId, a.classArmId, a.sessionTermId, a.status, a.dateTimeTaken, b.className, c.classArmName,
                        e.firstName, e.lastName, e.otherName, e.admissionNumber FROM tblattendance AS a
                        INNER JOIN tblclass AS b ON b.Id = a.classId
                        INNER JOIN tblclassarms AS c ON c.Id = a.classArmId
                        INNER JOIN tblstudents AS e ON e.admissionNumber = a.admissionNo";
                       }
                       if($type == "2"){ 
                        ...
                        INNER JOIN tblclassarms AS c ON c.Id = a.classArmId
                        INNER JOIN tblstudents AS e ON e.admissionNumber = a.admissionNo
                        WHERE a.classId = $_SESSION[classId] AND a.classArmId = $_SESSION[classArmId] AND a.admissionNo = $admissionNumber AND a.dateTimeTaken = '$singleDate'";
                       }
                       if($type == "3"){ 
                         ...
                         INNER JOIN tblclassarms AS c ON c.Id = a.classArmId
                         INNER JOIN tblstudents AS e ON e.admissionNumber = a.admissionNo
                         WHERE a.classId = $_SESSION[classId] AND a.classArmId = $_SESSION[classArmId] AND a.admissionNo = $admissionNumber AND a.dateTimeTaken BETWEEN '$fromDate' AND '$toDate'";
                       }
